...
import BlogPosts from "../../img/BlogPosts.png"
import 'swiper/css'
    ...
    return(
        <div className="portfolio" id="portfolio">
         ...
         className="portfolio-slider">
           ...
           <img src={BlogPosts} alt="" />
           <h1 className="info" >Html + Css + Js, nodejs, express, ejs</h1>
           <a href="https://github.com/azadehahmadi080/BlogProjectpost">
           <button className="button">View Project<i className="fas fa-chevron-right"></i></button></a>
       </SwiperSlide>
