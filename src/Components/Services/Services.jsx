    ...
    return(
        <div className="services" id="services">
            ...
            <div className="awesome">
                ...
                <span>services</span>
                <span>I am a FullStack web developer with knowledge in both the front-end and back-end parts of creating websites.
                    <br />
                    My skills in front-end includes: HTML, CSS, BootStrap, Tailwind, JavaScript, Git, Github.
                    <br /> and Back-end parts includes: Nodejs, Express, hosting, Api.
                <br/>
                and areas in which i work; Fullstack developer, Web Desighn, Photoshop.
                <br />
